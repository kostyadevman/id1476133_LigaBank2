      ...
      <div className="container">
        <div className="footer__wrapper">
          ...
          <section className="footer__sms sms">
            ...
            <p className="sms__code"><b>*0904</b></p>
          ...
          <section className="footer__phone phone">
            ...
            <a className="phone__link" href="tel:88001112233"><b>8 800 111 22 33</b></a>
          ...
          <section className="footer__social social">
            ...
            <ul className="social__list">
              ...
              <li className="social__item">
                <a className="social__link" target="_blank" rel="noreferrer" href="https://www.youtube.com/">
                  <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
